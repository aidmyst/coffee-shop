        ...
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-7 flex flex-col gap-6">
                    ...
                    @foreach (['Coffee', 'Non-Coffee', 'Tea', 'Juice', 'Snack', 'Dessert'] as $cat)
                        @if ($menus->where('category', $cat)->count() > 0)
                            <div x-show="search === '' || {{ $menus->where('category', $cat)->pluck('name')->map(fn($n) => strtolower($n))->values()->toJson() }}.some(name => name.includes(search.toLowerCase()))"
                ...
                <div class="col-span-5 relative">
                    <div class="bg-white p-6 shadow sm:rounded-2xl border sticky top-6 flex flex-col"
                        ...
                        <div class="mt-4 pt-4 border-t">
                            ...
                            <form method="POST" action="{{ route('order.submit') }}" x-data="{ orderType: 'Takeaway' }"
    ...
    <div x-data="{ open: true }" x-show="printId !== null" x-cloak
        ...
        <div
            ...
            <div class="w-full bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200 overflow-hidden mb-6"
                style="height: 300px;">
                <iframe id="receiptFrame" :src="printId ? '{{ url('order/print') }}/' + printId : ''"
