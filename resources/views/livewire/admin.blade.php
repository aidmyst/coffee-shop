<div> {{-- root tunggal Livewire --}}
    {{-- Wrapper Pantauan Aktivitas + Backdate --}}
    ...
    <div wire:poll.visible.5s>
        {{-- Total Pendapatan dan Total Pesanan --}}
        <div class="max-w-full mx-auto sm:px-6 lg:px-8 transition-all grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white p-6 rounded-xl shadow-sm border-l-4 border-blue-500">
                ...
                <h3 class="text-2xl font-black text-gray-800 tracking-tight">{{ $orders->count() }} Transaksi</h3>
            </div>
        </div>
                            ...
                            @forelse ($orders->where('status', 'completed')->sortByDesc('updated_at') as $order)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                        ...
                                        {{ $order->status == 'pending' ? 'bg-yellow-50 text-yellow-700 border-yellow-200' : 'bg-green-50 text-green-700 border-green-200' }}">
