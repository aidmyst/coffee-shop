<aside
    ...
    <nav class="mt-4 flex-1 px-4 space-y-2 overflow-y-auto">
        ...
        <a href="<?php echo e(route('dashboard')); ?>"
            class="flex items-center justify-between p-3 rounded-lg transition-colors <?php echo e(request()->routeIs('dashboard') ? 'bg-orange-100 text-orange-700 font-bold' : 'text-gray-600 hover:bg-gray-100'); ?>"
            title="Pesanan Masuk">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->role === 'admin'): ?>
            <a href="<?php echo e(route('admin.menu.create')); ?>"
                class="flex items-center p-3 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.menu.*') ? 'bg-orange-100 text-orange-700 font-bold' : 'text-gray-600 hover:bg-gray-100'); ?>"
            ...
            <a href="<?php echo e(route('admin.report.statistic')); ?>"
                class="flex items-center p-3 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.report.*') ? 'bg-orange-100 text-orange-700 font-bold' : 'text-gray-600 hover:bg-gray-100'); ?>"
            ...
            <a href="<?php echo e(route('admin.tables.kode_qr')); ?>"
                class="flex items-center p-3 rounded-lg transition-colors <?php echo e(request()->routeIs('admin.tables.*') ? 'bg-orange-100 text-orange-700 font-bold' : 'text-gray-600 hover:bg-gray-100'); ?>"
            ...
            <a href="<?php echo e(route('profile.edit')); ?>"
                class="flex items-center p-3 rounded-lg transition-colors <?php echo e(request()->routeIs('profile.*') ? 'bg-orange-100 text-orange-700 font-bold' : 'text-gray-600 hover:bg-gray-100'); ?>"
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Auth::user()->role === 'kasir'): ?>
            <a href="<?php echo e(route('casshier.reports.history')); ?>"
                class="flex items-center p-3 rounded-lg transition-colors <?php echo e(request()->routeIs('casshier.reports.*') ? 'bg-orange-100 text-orange-700 font-bold' : 'text-gray-600 hover:bg-gray-100'); ?>"
            ...
            <a href="<?php echo e(route('casshier.pos.order')); ?>"
                class="flex items-center p-3 rounded-lg transition-colors <?php echo e(request()->routeIs('casshier.pos.*') ? 'bg-orange-100 text-orange-700 font-bold' : 'text-gray-600 hover:bg-gray-100'); ?>"
