                    ...
                    <div class="bg-white p-2 rounded-xl shadow-sm border flex flex-wrap gap-2 items-center">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                <button
                                    @click="activeFilter = '<?php echo e($f); ?>'; window.scrollTo({ top: 0})"
                                    :class="activeFilter === '<?php echo e($f); ?>'
                                        ?
            ...
            <div class="grid grid-cols-1 lg:grid-cols-10 gap-6">
                ...
                <div class="lg:col-span-7 flex flex-col gap-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <div x-show="
                            (activeFilter === 'Semua' || activeFilter === '<?php echo e($cat); ?>') &&
                            (search === '' || 
                            <?php echo e($menus->where('category', $cat)->pluck('name')->map(fn($n) => strtolower($n))->values()->toJson()); ?>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $menus->where('category', $cat); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                                    ...
                                    <div x-show="search === '' || '<?php echo e(strtolower($menu->name)); ?>'.includes(search.toLowerCase())"
                                        ...
                                        <div class="p-3 flex flex-col flex-1">
                                            ...
                                            <div class="flex flex-col gap-1 mt-2 pt-2 border-t border-gray-50">
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($menu->category === 'Snack' || $menu->category === 'Dessert'): ?>
                                                    <div class="flex justify-between items-center">
                                                        <span
                                                            class="text-[10px] font-bold text-gray-400 uppercase tracking-tighter">Harga</span>
                                                        <p class="text-sm font-black text-gray-800">
                                                            Rp<?php echo e(number_format($menu->price_hot)); ?></p>
                                                    </div>
                                                <?php else: ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($menu->price_hot): ?>
                                                        <div class="flex justify-between items-center">
                                                            <span
                                                                class="text-[10px] font-bold uppercase tracking-tighter <?php echo e(($menu->category === 'Non-Coffee' && $menu->name === 'Mineral Water') || $menu->category === 'Juice' ? 'text-gray-400' : 'text-orange-600'); ?>">
                                                                <?php echo e(($menu->category === 'Non-Coffee' && $menu->name === 'Mineral Water') || $menu->category === 'Juice' ? 'Normal' : 'Hot'); ?>
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($menu->price_ice): ?>
                                                        <div class="flex justify-between items-center">
                                                            <span
                                                                class="text-[10px] font-bold text-blue-500 uppercase tracking-tighter">Ice</span>
                                                            <p class="text-sm font-black text-gray-800">
                                                                Rp<?php echo e(number_format($menu->price_ice)); ?></p>
                                                        </div>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-center gap-1.5">
                                                    ...
                                                    <form action="<?php echo e(route('admin.menu.toggle-stock', $menu->id)); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
                        ...
                        <?php echo e($menu->is_available ?? true ? 'bg-green-50 text-green-600 hover:bg-green-600 hover:text-white' : 'bg-red-50 text-red-600 hover:bg-red-600 hover:text-white filter-none'); ?>"
                                                            style="filter: grayscale(0%); opacity: 1;">
                                                            <?php echo e($menu->is_available ?? true ? 'Tersedia' : 'Habis'); ?>
                                                    ...
                                                    <button
                                                        @click="editingMenu={ id: '<?php echo e($menu->id); ?>' , name: '<?php echo e($menu->name); ?>' , price_hot: '<?php echo e($menu->price_hot); ?>' , price_ice: '<?php echo e($menu->price_ice); ?>' , category: '<?php echo e($menu->category); ?>' }; showEditModal=true"
                                                    ...
                                                    <form action="<?php echo e(route('admin.menu.destroy', $menu->id)); ?>"
                                                        method="POST"
                                                        onsubmit="return confirm('Hapus <?php echo e($menu->name); ?>?')">
                                                    ...
                                                    <a href="<?php echo e(route('admin.menu.recipe', $menu->id)); ?>"
                                                        title="Kelola Resep"
                                                        class="p-1.5 rounded-lg bg-orange-50 text-orange-600 hover:bg-orange-600 hover:text-white transition shadow-sm flex items-center justify-center"
                                                        style="filter: grayscale(0%); opacity: 1;">
                                                        <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                            viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\coffee-shop\resources\views/admin/menu/create.blade.php ENDPATH**/ ?>